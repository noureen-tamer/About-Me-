...
<p align="left">Hi there! I'm Noureen, an AI Engineer, Data Scientist, and Network Engineer based in Egypt. I'm currently a Junior Student at the Egypt Japan University of Science and Technology (E-JUST), where I'm pursuing my passion for cutting-edge technologies and innovative solutions.<br><br>I'm deeply passionate about Deep Learning, Machine Learning, Neural Networks, and Data Engineering. I love exploring how data can be transformed into actionable insights and how intelligent systems can be built to solve real-world problems. My goal is to contribute to the advancement of AI and make a meaningful impact in the field.</p>
...
<p align="left">I'm always eager to expand my knowledge and skills. Currently, I'm diving into:<br><br>Neural Network Architectures: Reinforcement Learning<br><br>Machine Learning & Data Science: Advanced algorithms, model optimization, and data visualization techniques.<br><br>Cloud Computing: AWS, Google Cloud Platform (GCP)</p>
